...
const EMPLOYEES = [
    { id: 'EMP-001', name: 'Souradeep Pradhan', email: 'souradeep@f4.co', password: 'password123', role: 'admin', department: 'Engineering', position: 'Team Lead', status: 'active', avatar: 'SP', joinDate: '2024-01-15', salary: 85000, phone: '+91 98765 43210' },
    { id: 'EMP-002', name: 'Riya Sharma', email: 'riya@f4.co', password: 'password123', role: 'admin', department: 'HR', position: 'HR Manager', status: 'active', avatar: 'RS', joinDate: '2023-08-10', salary: 78000, phone: '+91 91234 56789' },
    { id: 'EMP-003', name: 'Arjun Mehta', email: 'arjun@f4.co', password: 'password123', role: 'employee', department: 'Design', position: 'UI Designer', status: 'active', avatar: 'AM', joinDate: '2024-03-20', salary: 65000, phone: '+91 87654 32109' },
    { id: 'EMP-004', name: 'Priya Nair', email: 'priya@f4.co', password: 'password123', role: 'employee', department: 'Marketing', position: 'Analyst', status: 'on-leave', avatar: 'PN', joinDate: '2023-11-05', salary: 60000, phone: '+91 76543 21098' },
    { id: 'EMP-005', name: 'Karan Gupta', email: 'karan@f4.co', password: 'password123', role: 'employee', department: 'Engineering', position: 'Developer', status: 'active', avatar: 'KG', joinDate: '2024-06-01', salary: 70000, phone: '+91 65432 10987' },
    { id: 'EMP-006', name: 'Neha Joshi', email: 'neha@f4.co', password: 'password123', role: 'employee', department: 'Finance', position: 'Accountant', status: 'active', avatar: 'NJ', joinDate: '2023-05-22', salary: 62000, phone: '+91 54321 09876' }
];
